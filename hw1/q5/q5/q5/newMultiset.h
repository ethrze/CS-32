...
#ifndef __q5__newMultiset__
#define __q5__newMultiset__
...
public:
    ...
    Multiset(int size); // Create an empty multiset of size size. 
    
    Multiset(const Multiset &other); // copy constructor
    
    Multiset& operator=(const Multiset &rhs); // Copy constructor
...
#endif /* defined(__q5__newMultiset__) */
